      ...
      <div className="relative z-10 max-w-[1700px] mx-auto w-full px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 items-center gap-12 lg:gap-0">
        ...
        <div className="lg:col-span-5 flex flex-col space-y-8 lg:space-y-10 text-center lg:text-left order-2 lg:order-1">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl lg:text-[8.5rem] font-black leading-[1] lg:leading-[0.85] tracking-tighter text-white">
              Hi, <span className="md:hidden"> </span>{" "}
              <br className="hidden md:block" />I am{" "}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 lg:gap-8 pt-4">
            <a
              href="https://wa.me/8801309834483" // আপনার নম্বরটি এখানে (Country code সহ)
              target="_blank"
              rel="noopener noreferrer"
              className="group relative w-full sm:w-auto px-10 py-5 bg-white text-[#020617] font-black rounded-2xl transition-all hover:scale-105 shadow-xl flex items-center justify-center"
            >
              <span className="relative z-10 flex items-center justify-center gap-4 uppercase tracking-[0.2em] text-sm">
                Hire Me <ArrowRight size={18} />
              </span>

              {/* একটি হালকা অ্যানিমেশন এফেক্ট (ঐচ্ছিক) */}
              <motion.div
                animate={{ x: ["-100%", "200%"] }}
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social, i) => (
                <a
                  ...
                  href={social.url}
                  target="_blank"
                  className="p-3 bg-white/5 rounded-xl border border-white/10 text-slate-400 hover:text-cyan-400 transition-colors"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="lg:col-span-4 flex flex-col items-center lg:items-end order-3">
          ...
          >
            ...
            <span className="text-cyan-500 font-black uppercase text-[10px] tracking-[0.4em]">
              Expertise
            </span>
            ...
            <div className="mt-8 pt-8 border-t border-white/5">
              <a
                ...
                download
                className="flex items-center gap-3 text-white font-bold text-[10px] uppercase tracking-widest hover:text-cyan-400 transition-colors"
              >
